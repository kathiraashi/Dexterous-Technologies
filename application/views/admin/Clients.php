				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="box box-primary form_html">
							<!-- /.box-header -->
							<div class="box-body">
								<form id="form_1" action="<?=base_url()?>index.php/Admin/Clients_Update" onsubmit="return validateMyForm_1();"
                                        ...
                                        <?php foreach ($clients as $logo) { ?>
                                          ...
                                          <div class="col-sm-3">
                                           <div class="form-group">
                                             ...
                                             <img src="<?=base_url()?>assets/Uploads/Images/<?=$logo->Image?>" id="preview-img<?=$logo->id?>" style="width: 100%; height: 100px;" />
                                           </div>
                                          </div>     
